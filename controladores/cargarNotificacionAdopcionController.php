<?php
  ...
  require_once ('../clases/SolicitudAdopcionClass.php');
  ...
  $descripcion = "Desea adoptar a tu mascota ".$mascota['nombreMascota'].
  ...
  $solicitudAdopcion = new SolicitudAdopcion($idUsuarioEmisor,$idMuroMascota);
  $solicitudAdopcion->persistirSolicitudAdopcion();
 ?>
